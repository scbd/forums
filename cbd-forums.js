angular.module('cbd-forums', [])
    .factory('forumHttp', ['$http', "$browser", '$rootScope', function($http, $browser, $rootScope) {
    ...
    .factory('commonJS', ['$rootScope', '$browser', function($scope, $browser) {
    ...
    .directive("forumDetails", [function() {
                ...
                function($scope, $http, _, $q, $filter, $timeout, $location, $routeParams, $timeout, commonJS, $element, $rootScope) {
                    ...
                    $scope.loadPosts = function(threadId) {
                        ...
                        $q.all([thread, threadPosts]).then(function(response) {
                                ...
                                $scope.onPostsLoad({posts:$scope.forumPosts});
                                if ($location.$$hash) {
                                    $timeout(function() {
    ...
    .directive("forumThreads", [function() {
